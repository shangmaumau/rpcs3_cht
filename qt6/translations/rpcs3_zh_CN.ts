...
<context>
    ...
    <message>
        ...
        <translation>当前值: %1 (%2)</translation>
    </message>
    <message>
        <location filename="rpcs3qt/auto_pause_settings_dialog.cpp" line="287"/>
        <source>OK</source>
...
<context>
    ...
    <message>
        ...
        <oldsource>App Music</oldsource>
        <translation>音乐应用</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PS2 经典</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PS1 经典</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PSP 重制</translation>
    </message>
    <message>
...
If chosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</source>
        <oldsource>These libraries are LLE&apos;d by default (lower list), selection will switch to HLE.
LLE - &quot;Low Level Emulated&quot;, function code inside the selected SPRX file will be used for exported firmware functions.
HLE - &quot;High Level Emulated&quot;, alternative emulator code will be used instead for exported firmware functions.
...
HLE - &quot;High Level Emulated&quot;, alternative emulator code will be used instead for exported firmware functions.
If chosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</source>
        <oldsource>These libraries are HLE&apos;d by default (upper list), selection will switch to LLE.
LLE - &quot;Low Level Emulated&quot;, function code inside the selected SPRX file will be used for exported firmware functions.
HLE - &quot;High Level Emulated&quot;, alternative emulator code will be used instead for exported firmware functions.
If choosen wrongly, games will not work! If unsure, leave both lists empty. HLEing all SPRX allows to boot without firmware installed. (experimental)</oldsource>
...
· 「Precise」（精准）是对 PS3 行为的最精准（模拟）。在一些作品中为求精准的视觉效果，此模式是必须的，如《恶魔之魂》（Demon&apos;s Souls）和《黑暗》（The Darkness）。
...
Can affect performance in unexpected ways.</source>
        <oldsource>Changes the sleep period accuracy.
&apos;As Host&apos; uses default accuracy of the underlying operating system, while &apos;All Timers&apos; attempts to improve it.
&apos;Usleep Only&apos; limits the adjustments to usleep syscall only.
...
XAudio2 uses native Windows sounds system, is the next best alternative.</oldsource>
...
If unsure, use this option.</source>
        <oldsource>Recompiles the game&apos;s executable once before running it for the first time.
This is by far the fastest option and should always be used.
Should you face compatibility issues, fall back to one of the Interpreters and retry.
...
Only disable this if you want to get ingame more quickly.</source>
        <oldsource>Searches the game&apos;s directory and precompiles extra PPU modules during boot.
If disabled, these modules will only be compiled when needed. Depending on the game, this might interrupt the gameplay unexpectedly and possibly frequently.
Only disable this if you want to get ingame more quickly.</oldsource>
        <translation>在启动期间，搜索游戏目录并预编译额外的 PPU 和 SPU 模块。
如果禁用，这些模块则仅在需要时才编译。根据游戏的不同，此选项可能会非预期且（也许会）频繁地打断游玩。
...
This setting is only applied when SPU Decoder is set to Dynamic or LLVM.</source>
        <oldsource>Adds extra accuracy to SPU float vectors processing.
Fixes bugs in various games at the cost of performance.
...
也允许 Vulkan 使用调试标记来取得更佳的 RenderDoc 捕获。
...
在一些情形下可能会导致纹理毁坏。</translation>
    ...
    <message>
        ...
        <translation>强制纹理冲刷——即便在一些不那么必要或不那么正确的情况下。已知会导致视觉伪影，但对调试特定的纹理缓存问题是有用的。</translation>
    </message>
    <message>
...
Numerical values control whether or not to enable the accurate version based on the atomic operation&apos;s length.</source>
        <translation>启用后，PPU 原子操作会运行在整个缓存行数据上，禁用后，相反的，则只有一个单独的 64 位内存块。
...
2 为默认值，如不确定，请勿修改此设置。</translation>
    ...
    <message>
        ...
        <translation>解释器（慢）。如果 PPU 重编译器（LLVM）不工作，可以试下这个。</translation>
    </message>
    <message>
...
&quot;Atomic &amp; Ordered&quot; is the most accurate but it is the slowest and without much stability benefit in games over &quot;Atomic&quot; which benefits stability greatly in many games with little performance penalty.</oldsource>
        <translation>「Fast」是最不精准的设置，（此模式下）RSX 不模拟原子 FIFO 缓冲。
「Atomic」极大地有益于许多游戏的稳定性，只损耗一点点性能。
「Atomic Ordered」最精准但也最慢，且对游戏的稳定性没多少益处。</translation>
    </message>
    <message>
...
Known to fix the rhythm game Space Channel 5 Part 2</source>
        <translation>将 VBLANK 的速率乘以 1000/1001 以获得像 59.94Hz （这样的帧率），
...
手动设置会使用你选择的格式，自动设置会让游戏从所有可用的格式中（自动）选择。</translation>
    ...
    <message>
        ...
        <translation>备用解释器（慢）。可能比静态解释器快些。如果 PPU 重编译器（LLVM）不工作，就试一下这个。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/tooltips.h" line="79"/>
        <source>Interpreter (slow). Try this if SPU Recompiler (LLVM) doesn&apos;t work.</source>
        <translation>解释器（慢）。如果 SPU 重编译器（LLVM）不工作，就试一下这个。</translation>
    </message>
    <message>
        ...
        <translation>备选解释器（慢）。可能比静态解释器快些。如果 SPU 重编译器（LLVM）不工作，就试一下这个。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
        <translation>旧版选项。在 PPU LLVM 的非 Java 模式下，修正结果向量值。
...
If unsure, do not modify this setting.</source>
        <translation>在 PPU 后端的向量操作中，遵循「非 Java 模式位」的值。
如不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
        <translation>在 PPU 后端的向量指令里，修正 NaN 结果。
如不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
If unsure, do not modify this setting.</source>
        <translation>在 PPU 后端的向量指令里，精准设定 NaN 结果。
如不确定，请勿修改此设置。</translation>
    </message>
    <message>
...
The lighter the game is on the hardware, the more power is saved by it. (until the preemption count barrier is reached)</source>
        <oldsource>Reduces CPU usage and power consumption, on mobile devices improves battery life. (0 means disabled)
Higher values cause a more pronounced effect, but may cause audio or performance issues. A value of 50 or less is recommended.
This option forces an FPS limit because it&apos;s active when framerate is stable.
The lighter the game is on the hardware, the more power is saved by it. (until the preemption count barrier is reached)</oldsource>
        <translation>减少 CPU 使用和电量消耗，在移动设备上提升电池续航。（0 意味着已禁用）
更高的值会带来更显著的效果，但可能引起音频或性能的问题。推荐 50 或更小的值。
此选项会强制帧率固定，因为帧率稳定时它才有效。
游戏占用硬件越少，它节省的电量就越多（直至达到抢占计数的栅栏）。</translation>
    </message>
    <message>
...
「Over-Under」更接近原生的立体输出，但通常受支持较少。</translation>
    </message>
    <message>
...
Check this if you want to play with mouse and keyboard (for example with UCR).</source>
        <translation>游戏屏幕处于活跃态时，禁用双击对全屏模式的触发。
如果你想用鼠标和键盘游玩（例如用 UCR（按：指 Univeral Control Remapper，一个按键重映射工具）），请检查此项。</translation>
    </message>
    <message>
...
目前可能并非每次都有效。</translation>
    ...
    <message>
        ...
        <oldsource>Locks the mouse cursor at center when the fullscreen mode is active.</oldsource>
        <translation>全屏模式处于活跃态时，将鼠标光标锁定至中心位置。</translation>
    </message>
    <message>
        ...
        <translation>如果在配置的时间内未检测到鼠标移动，则隐藏鼠标光标。</translation>
    </message>
    <message>
...
在这种情形下，无论何时只要主页菜单在打开着便暂停模拟，就较为有用了。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>设定性能蒙层在屏幕上的位置（象限）。</translation>
    </message>
    <message>
...
性能蒙层的刷新率并不会影响帧率图表统计，且只能与当前游戏允许的速度一样快。</translation>
    </message>
    <message>
        ...
        <translation>设定性能蒙层的字体大小（以像素计）。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>将性能蒙层垂直居中，并覆盖垂直边距。</translation>
    </message>
    <message>
...
如不确定，请使用 Vulkan。要是你有任何兼容性问题，请回退至 OpenGL。</translation>
    </message>
    <message>
...
Rarely due to emulation bugs some games will only render at low resolutions like 480p.</source>
        <oldsource>This setting will be ignored if the Resolution Scale is set to anything other than 100%!
Leave this on 1280x720, every PS3 game is compatible with this resolution.
Only use 1920x1080 if the game supports it.
...
Infinite adds a positive feedback loop which adds another vblank signal per frame allowing more games to be fps limitless.</source>
        <oldsource>Off is the fastest option.
...
PS3 native should only be used if Auto is not working correctly as it can introduce frame-pacing issues.
Infinite adds a positive feedback loop which adds another vblank signal per frame allowing more games to be fps limitless.</oldsource>
        <translation>「Off」是最快的选项。
使用帧率限制器会增加额外开支并减慢游戏。然而，如果帧率过高，有些游戏就会崩溃。
仅当「Auto」不能正常工作时，才使用 PS3 原生，因为它会引起帧同步问题。
「Infinite」添加了一个正反馈循环，即为每一帧添加另一个 vblank 信号以允许更多游戏的帧率趋于无限。</translation>
    </message>
    <message>
...
《恶魔之魂》（Demon&apos;s Souls）必须启用。</translation>
    ...
    <message>
        ...
        <oldsource>By having this off you might obtain a higher frame rate at the cost of tearing artifacts in the game.</oldsource>
        <translation>通过关掉此项，你可能会得到一个更高的帧率，但代价是游戏内的撕裂的物件。</translation>
    </message>
    <message>
...
尽管现在它也会暂停游戏游玩，但还是不推荐你（过于）依赖它，因为此行为在未来可能会有所改变，而且这也不是本设置项的目的。</translation>
    ...
    <message>
        ...
        <translation>覆盖宽高比，并将图像拉伸至整个显示区域。</translation>
    </message>
    <message>
...
May cause slowdown in some situations due to the extra worker thread load.</oldsource>
        <translation>将一些 RSX 操作切换（offload）到次要线程。
强核心处理器可提升表现。
...
仅在着色器模式设为某种异步模式时才有影响。</translation>
    ...
    <message>
        <location filename="rpcs3qt/tooltips.h" line="185"/>
...
FidelityFX 目前不支持立体 3D 输出。</translation>
    ...
    <message>
        <location filename="rpcs3qt/tooltips.h" line="191"/>
...
必须重启 RPCS3 才能完全关闭连接。</translation>
    ...
    <message>
        <location filename="rpcs3qt/tooltips.h" line="209"/>
...
真正的吉他控制器可与模拟的吉他控制器同时使用。</translation>
    ...
    <message>
        <location filename="rpcs3qt/tooltips.h" line="228"/>
...
在屏幕校准期间，这可能会非常有用。</translation>
    ...
    <message>
        ...
        <oldsource>Select up to 3 emulated midi devices and their type.</oldsource>
...
Can be reset to current wall clock time by clicking &quot;Set to Now&quot;.</source>
        <oldsource>Sets the time to be used within the console. This will be applied as an offset that tracks wall clock time.
Can be reset to current wallclock time by clicking &quot;Set to Now&quot;.</oldsource>
...
To bind mouse movement to a button or joystick, click on the desired button to activate it, then click and hold while dragging the mouse to a direction.</oldsource>
    ...
    <message>
        ...
        <translation>为使用 DualShock 3 处理程序，你可能需要添加 udev 规则来让 RPCS3 使用控制器。&lt;br&gt;请参阅 &lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 维基&lt;/a&gt; 的说明。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <oldsource>The evdev handler should work with any controller that has linux support.&lt;br&gt;If your joystick is not being centered properly, read the &lt;a href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt; for instructions.</oldsource>
        <translation>「XInput」处理程序适用于 Xbox 控制器和众多第三方 PC 兼容控制器。如果 SCP 的 XInput1_3.dll 放在了 RPCS3 的主目录下，SCP 的压感按键就是支持的。欲获取更多细节，请参阅 &lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 维基&lt;/a&gt;。</translation>
    </message>
    <message>
        ...
        <oldsource>The evdev handler should work with any controller that has linux support.&lt;br&gt;If your joystick is not being centered properly, read the &lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 Wiki&lt;/a&gt; for instructions.</oldsource>
        <translation>「evdev」处理程序应当适用于任何支持 Linux 的控制器。&lt;br&gt;如果你的摇杆未正常居中，请阅读 &lt;a %0 href=&quot;https://wiki.rpcs3.net/index.php?title=Help:Controller_Configuration&quot;&gt;RPCS3 维基&lt;/a&gt; 的相关说明。</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/tooltips.h" line="285"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/about_dialog.ui" line="14"/>
    ...
    <message>
        ...
        <oldsource>&lt;p&gt;&lt;b&gt;Contributors:&lt;/b&gt;&lt;br&gt;&lt;br&gt;BlackDaemon&lt;br&gt;elisha464&lt;br&gt;Aishou&lt;br&gt;krofna&lt;br&gt;xsacha&lt;br&gt;danilaml&lt;br&gt;unknownbrackets&lt;br&gt;Zangetsu38&lt;br&gt;lioncash&lt;br&gt;achurch&lt;br&gt;darkf&lt;br&gt;Syphurith&lt;br&gt;Blaypeg&lt;br&gt;Survanium90&lt;br&gt;georgemoralis&lt;br&gt;ikki84&lt;br&gt;scribam&lt;br&gt;TGE&lt;br&gt;velocity&lt;br&gt;Farseer&lt;br&gt;Dangles&lt;br&gt;ruipin&lt;br&gt;jbeich&lt;br&gt;CookiePLMonster&lt;br&gt;Whatcookie&lt;br&gt;rajkosto&lt;br&gt;Admiral Thrawn&lt;/p&gt;</oldsource>
    ...
    <message>
        <location filename="rpcs3qt/about_dialog.ui" line="247"/>
    ...
    <message>
        <location filename="rpcs3qt/about_dialog.ui" line="365"/>
        <source>Wiki</source>
        <translation>维基</translation>
    </message>
    <message>
        <location filename="rpcs3qt/about_dialog.ui" line="372"/>
        <source>Patreon</source>
        <translation>Patreon</translation>
    </message>
    <message>
        <location filename="rpcs3qt/about_dialog.ui" line="392"/>
        <source>Close</source>
        <translation>关闭</translation>
    </message>
    <message>
        <location filename="rpcs3qt/about_dialog.cpp" line="17"/>
        <source>RPCS3 Version: %1</source>
        <translation>RPCS3 版本：%1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/about_dialog.cpp" line="18"/>
        <source>
...
要应用的话，必须重启游戏。你可以在设置中启用/禁用此功能。</translation>
    ...
    <message>
        <location filename="rpcs3qt/auto_pause_settings_dialog.cpp" line="31"/>
        <source>Clear</source>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/camera_settings_dialog.cpp" line="129"/>
        <location filename="rpcs3qt/camera_settings_dialog.cpp" line="225"/>
...
可能被另一个应用程序占用了。</translation>
    ...
    <message>
        <location filename="rpcs3qt/camera_settings_dialog.cpp" line="155"/>
        <source>%0x%1, %2-%3 FPS, Format=%4</source>
        <translation>%0x%1, %2-%3 FPS, 格式=%4</translation>
    </message>
</context>
<context>
    <name>cg_disasm_window</name>
    <message>
        <location filename="rpcs3qt/cg_disasm_window.cpp" line="19"/>
        <source>Cg Disasm</source>
        <translation>Cg 反汇编</translation>
    </message>
    <message>
        <location filename="rpcs3qt/cg_disasm_window.cpp" line="65"/>
        <source>&amp;Clear</source>
        <translation>&amp;清理</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/cheat_manager.cpp" line="1040"/>
        <source>0x%1</source>
...
<context>
    ...
    <message>
        ...
        <location filename="rpcs3qt/debugger_frame.cpp" line="1177"/>
    ...
    <message>
        <location filename="rpcs3qt/debugger_frame.cpp" line="308"/>
        <source>Debugger Guide &amp; Shortcuts</source>
        <translation>调试器指南与快捷方式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/debugger_frame.cpp" line="310"/>
...
Double-click: Set breakpoints.</source>
        <oldsource>Keys Ctrl+G: Go to typed address.
Keys Ctrl+B: Open breakpoints settings.
Keys Ctrl+C: Copy instruction contents.
Keys Ctrl+F: Find thread.
Keys Alt+S: Capture SPU images of selected SPU or generalized form when used from PPU.
...
Key Page-Up: Scroll upwards with steps count equal to the viewed instruction count.
Key Page-Down: Scroll downwards with steps count equal to the viewed instruction count.
Double-click: Set breakpoints.</oldsource>
        <translation>Ctrl+G：前往键入的地址。
Ctrl+B：打开断点设置。
Ctrl+C：复制指令内容。
Ctrl+F：查找线程。
...
双击：设定断点。</translation>
    ...
    <message>
        ...
        <location filename="rpcs3qt/debugger_frame.cpp" line="1199"/>
        <source>OK</source>
...
应用于所有线程的所有断点，而不管是在更改此设置之前或之后设定的。（看不懂）</translation>
    ...
    <message>
        <location filename="rpcs3qt/debugger_frame.cpp" line="1200"/>
        <source>Cancel</source>
        <translation>取消</translation>
    </message>
</context>
<context>
    ...
    <message>
        <location filename="rpcs3qt/debugger_list.cpp" line="28"/>
        <source>ASM</source>
        <translation>ASM</translation>
    </message>
    <message>
        <location filename="rpcs3qt/debugger_list.cpp" line="351"/>
...
错误：%1</translation>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="857"/>
...
只有你保存的时候，这个更改才会成为最终配置。</translation>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="888"/>
        <source>Safe</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="896"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="904"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="912"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="929"/>
        <source>Off</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="931"/>
        <source>60</source>
        <comment>Frame limit</comment>
        <translation>60</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="932"/>
        <source>30</source>
        <comment>Frame limit</comment>
        <translation>30</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="933"/>
        <source>Auto</source>
        <comment>Frame limit</comment>
        <translation>自动</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="934"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="941"/>
        <source>Disabled</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="948"/>
        <source>Auto</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="959"/>
        <source>FidelityFX Super Resolution</source>
        <comment>Output Scaling Mode</comment>
        <translation>FidelityFX 超级分辨率</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="965"/>
        <source>Disable Audio Output</source>
        <comment>Audio renderer</comment>
        <translation>禁用音频输出</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="967"/>
        <source>XAudio2</source>
        <comment>Audio renderer</comment>
        <translation>XAudio2</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="969"/>
        <source>Cubeb</source>
        <comment>Audio renderer</comment>
        <translation>Cubeb</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="971"/>
        <source>FAudio</source>
        <comment>Audio renderer</comment>
        <translation>FAudio</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="978"/>
        <source>Disabled</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="988"/>
        <source>Null</source>
        <comment>Keyboard handler</comment>
        <translation>空</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="989"/>
        <source>Basic</source>
        <comment>Keyboard handler</comment>
        <translation>Basic</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="995"/>
        <source>Null</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1002"/>
        <source>Unknown</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1004"/>
        <source>PS Eye</source>
        <comment>Camera type</comment>
        <translation>PS Eye</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1005"/>
        <source>UVC 1.1</source>
        <comment>Camera type</comment>
        <translation>UVC 1.1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1011"/>
        <source>No</source>
        <comment>Camera flip</comment>
        <translation>否</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1012"/>
        <source>Flip horizontally</source>
        <comment>Camera flip</comment>
        <translation>水平翻转</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1013"/>
        <source>Flip vertically</source>
        <comment>Camera flip</comment>
        <translation>垂直翻转</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1014"/>
        <source>Flip both axes</source>
        <oldsource>Flip both axis</oldsource>
        <comment>Camera flip</comment>
        <translation>双轴翻转</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1020"/>
        <source>Null</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1028"/>
        <source>Null</source>
        <comment>Music handler</comment>
        <translation>空</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1029"/>
        <source>Qt</source>
        <comment>Music handler</comment>
        <translation>Qt</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1035"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1042"/>
        <source>Null</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1046"/>
        <source>Gun</source>
        <comment>Gun handler</comment>
        <translation>光线枪</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1101"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1109"/>
        <source>None</source>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1112"/>
        <source>Medium</source>
        <comment>Detail Level</comment>
        <translation>中</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1113"/>
        <source>High</source>
        <comment>Detail Level</comment>
        <translation>高</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1119"/>
        <source>Top Left</source>
        <comment>Performance overlay position</comment>
        <translation>左上</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1120"/>
        <source>Top Right</source>
        <comment>Performance overlay position</comment>
        <translation>右上</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1121"/>
        <source>Bottom Left</source>
        <comment>Performance overlay position</comment>
        <translation>左下</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1122"/>
        <source>Bottom Right</source>
        <comment>Performance overlay position</comment>
        <translation>右下</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1128"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1129"/>
        <source>Recompiler (LLVM)</source>
        <comment>PPU decoder</comment>
        <translation>重编译器（LLVM）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1135"/>
        <source>Interpreter (static)</source>
        <oldsource>Interpreter (precise)</oldsource>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1136"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1155"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1172"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1179"/>
        <source>HDMI 0</source>
        <comment>Audio Avport</comment>
        <translation>HDMI 0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1180"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1190"/>
        <source>America</source>
        <comment>License Area</comment>
        <translation>美洲</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1191"/>
        <source>Europe, Oceania, Middle East, Russia</source>
        <comment>License Area</comment>
        <translation>欧洲，大洋洲，中东，俄罗斯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1192"/>
        <source>Southeast Asia</source>
        <comment>License Area</comment>
        <translation>东南亚</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1213"/>
        <source>Italian</source>
        <comment>System Language</comment>
        <translation>意大利文</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1214"/>
        <source>Dutch</source>
        <comment>System Language</comment>
        <translation>荷兰文</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1215"/>
        <source>Portuguese (Portugal)</source>
        <comment>System Language</comment>
        <translation>葡萄牙文（葡萄牙）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1216"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1219"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1223"/>
        <source>Norwegian</source>
        <comment>System Language</comment>
        <translation>挪威文</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1224"/>
        <source>Polish</source>
        <comment>System Language</comment>
        <translation>波兰文</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1225"/>
        <source>English (UK)</source>
        <comment>System Language</comment>
        <translation>英文（英国）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1226"/>
    ...
    <message>
        ...
        <comment>Keyboard Type</comment>
        <translation>德文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1238"/>
        <source>Spanish keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>西班牙文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1239"/>
        <source>French keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>法文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1240"/>
        <source>Italian keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>意大利文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1241"/>
        <source>Dutch keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>荷兰文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1242"/>
        <source>Portuguese keyboard (Portugal)</source>
        <comment>Keyboard Type</comment>
        <translation>葡萄牙文键盘（葡萄牙）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1243"/>
        <source>Russian keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>俄文键盘</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <comment>Keyboard Type</comment>
        <translation>韩文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1246"/>
        <source>Norwegian keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>挪威文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1247"/>
        <source>Finnish keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>芬兰文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1248"/>
        <source>Danish keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>丹麦文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1249"/>
        <source>Swedish keyboard</source>
        <comment>Keyboard Type</comment>
        <translation>瑞典文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1250"/>
        <source>Chinese keyboard (Traditional)</source>
        <comment>Keyboard Type</comment>
        <translation>中文键盘（繁体）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1251"/>
    ...
    <message>
        ...
        <comment>Keyboard Type</comment>
        <translation>土耳其文键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1264"/>
        <source>Automatic (Default)</source>
        <comment>Exclusive Fullscreen Mode</comment>
        <translation>自动（默认）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1265"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1282"/>
    ...
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1289"/>
        <source>Accurate XFloat</source>
        <translation>精准 XFloat</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1290"/>
        <source>Approximate XFloat</source>
        <translation>近似 XFloat</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1291"/>
        <source>Relaxed XFloat</source>
        <translation>轻松 XFloat</translation>
    </message>
    <message>
        <location filename="rpcs3qt/emu_settings.cpp" line="1292"/>
        <source>Inaccurate XFloat</source>
        <translation>不精准 XFloat</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/game_compatibility.cpp" line="228"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="58"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="140"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="141"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="192"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="978"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1332"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1348"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1666"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1710"/>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1024"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1027"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1098"/>
        <source>&amp;Change Custom Configuration</source>
        <translation>&amp;更改自定义配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1099"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1103"/>
        <source>&amp;Manage Game Patches</source>
        <oldsource>&amp;Configure Game Patches</oldsource>
        <translation>&amp;管理游戏补丁</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1104"/>
        <source>&amp;Create PPU/SPU Cache</source>
        <oldsource>&amp;Create PPU Cache</oldsource>
        <translation>&amp;创建 PPU/SPU 缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1192"/>
        <source>&amp;Remove HDD1 Cache</source>
        <translation>&amp;移除 HDD1 缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1456"/>
        <source>Cannot Remove Game</source>
        <translation>无法移除游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1456"/>
...
%1路径：%2</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1108"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1112"/>
        <source>&amp;Create Start Menu Shortcut</source>
        <translation>&amp;创建开始菜单快捷方式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1114"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1128"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1143"/>
        <source>&amp;Remove Custom Gamepad Configuration</source>
        <translation>&amp;移除自定义手柄配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1158"/>
        <source>&amp;Remove Shaders Cache</source>
        <translation>&amp;移除着色器缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1164"/>
        <source>&amp;Remove PPU Cache</source>
        <translation>&amp;移除 PPU 缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1170"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1209"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1327"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1642"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1682"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1721"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1772"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1823"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1874"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1222"/>
        <source>&amp;Open Install Folder</source>
        <translation>&amp;打开安装文件夹</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1225"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1252"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1260"/>
        <source>&amp;Replace Hover Gif</source>
        <translation>&amp;替换悬浮 Gif</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1261"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1300"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1316"/>
        <source>Remove Custom Icon of %0?</source>
        <translation>移除 %0 的自定义图标？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1319"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1322"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1395"/>
        <source>&amp;Copy Info</source>
        <translation>&amp;复制信息</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1396"/>
        <source>&amp;Copy Name + Serial</source>
        <translation>&amp;复制名称 + 序列号</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1397"/>
        <source>&amp;Copy Name</source>
        <translation>&amp;复制名称</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1398"/>
        <source>&amp;Copy Serial</source>
        <translation>&amp;复制序列号</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1467"/>
...
当前磁盘空余容量：%1
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1472"/>
        <source>Remove caches and custom configs</source>
        <translation>移除缓存与自定义配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1499"/>
        <source>Failure!</source>
        <translation>失败！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1500"/>
...
缓存与自定义配置未受影响。</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1501"/>
        <source>Failed to remove %0 from drive!
Path: %1</source>
        <translation>从硬盘中移除 %0 失败！
路径：%1</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1536"/>
...
%1</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1579"/>
        <source>Confirm Reset</source>
        <translation>确认重置</translation>
    </message>
    <message>
...
%0 [%1]</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1683"/>
...
你的配置会还原为全局手柄设置。</translation>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1684"/>
    ...
    <message>
        ...
        <location filename="rpcs3qt/game_list_frame.cpp" line="2066"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2110"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2155"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2202"/>
        <source>Cancel</source>
        <translation>取消</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1953"/>
        <source>%0
...
进度：%1/%2。正在为 %3 编译缓存……</translation>
    ...
    <message numerus="yes">
        <location filename="rpcs3qt/game_list_frame.cpp" line="1995"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="1996"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2042"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2088"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2132"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2177"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2224"/>
        <source>OK</source>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2016"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2062"/>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2106"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2041"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2176"/>
    ...
    <message>
        <location filename="rpcs3qt/game_list_frame.cpp" line="2223"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/game_list_grid.cpp" line="71"/>
        <source>%0 [%1]</source>
        <translation>%0 [%1]</translation>
    </message>
    <message>
        <location filename="rpcs3qt/game_list_grid.cpp" line="75"/>
        <source>%0 [%1]
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/gs_frame.cpp" line="1078"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="77"/>
        <source>Experimental Build Warning</source>
        <translation>实验性构建版本警告</translation>
    </message>
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="82"/>
        <source>
				&lt;p style=&quot;white-space: nowrap;&quot;&gt;
        ...
        <translation>
				&lt;p style=&quot;white-space: nowrap;&quot;&gt;
					...
					此构建版本包含一些变更，可能破坏游戏，甚至&lt;b&gt;毁损&lt;/b&gt;你的数据。&lt;br&gt;
					我们推荐从 &lt;a %0 href=&apos;https://rpcs3.net/download&apos;&gt;RPCS3 网站&lt;/a&gt;下载并使用官方构建版本。&lt;br&gt;&lt;br&gt;
					构建产地：%1&lt;br&gt;
					你一定要用这个构建版本吗？
				&lt;/p&gt;
			</translation>
    ...
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="148"/>
        <source>Warning</source>
        <translation>警告</translation>
    </message>
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="149"/>
...
请在运行 RPCS3 之前增加限制数量。</translation>
    ...
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="581"/>
...
一些线程可能已经死锁。正在终止。</translation>
    ...
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="598"/>
        <source>Terminate RPCS3</source>
        <translation>结束 RPCS3</translation>
    </message>
    <message>
        <location filename="rpcs3qt/gui_application.cpp" line="599"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/gui_settings.cpp" line="159"/>
        <source>Don&apos;t show again</source>
        <translation>不再显示</translation>
    </message>
    <message>
        <location filename="rpcs3qt/gui_settings.cpp" line="201"/>
        <source>Close Running Game?</source>
        <translation>关闭运行中的游戏？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/gui_settings.cpp" line="202"/>
...
Any unsaved progress will be lost!
    ...
    <message>
        <location filename="rpcs3qt/gui_settings.cpp" line="206"/>
...
Any unsaved progress will be lost!
    ...
    <message>
        <location filename="rpcs3qt/gui_settings.cpp" line="210"/>
        <source>Exit RPCS3?</source>
        <translation>退出 RPCS3？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/gui_settings.cpp" line="211"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/instruction_editor_dialog.cpp" line="24"/>
        <source>Edit instruction</source>
        <translation>编辑指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/instruction_editor_dialog.cpp" line="38"/>
        <source>OK</source>
        <oldsource>Ok</oldsource>
        <translation>确定</translation>
    </message>
    <message>
        <location filename="rpcs3qt/instruction_editor_dialog.cpp" line="39"/>
        <source>Cancel</source>
        <translation>取消</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/kernel_explorer.cpp" line="837"/>
...
<context>
    <name>log_frame</name>
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="115"/>
        <location filename="rpcs3qt/log_frame.cpp" line="156"/>
        <source>Log</source>
        <translation>Log</translation>
    </message>
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="141"/>
    ...
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="145"/>
    ...
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="157"/>
        <source>TTY</source>
    ...
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="266"/>
    ...
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="301"/>
        <source>Fatal</source>
    ...
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="305"/>
        <source>Warning</source>
        <translation>警告</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="317"/>
        <source>Stack Cell Errors</source>
        <translation>栈单元错误</translation>
    </message>
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="325"/>
        <source>Show Thread Prefix</source>
        <translation>显示线程前缀</translation>
    </message>
    <message>
        <location filename="rpcs3qt/log_frame.cpp" line="333"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/log_viewer.cpp" line="249"/>
        <source>Failed to open &apos;%0&apos;</source>
        <translation>打开 &apos;%0&apos; 失败</translation>
    </message>
    <message>
        <location filename="rpcs3qt/log_viewer.cpp" line="257"/>
        <source>Pasting...</source>
        <translation>正在粘贴……</translation>
    </message>
    <message>
        <location filename="rpcs3qt/log_viewer.cpp" line="273"/>
        <source>Filtering...</source>
        <translation>正在过滤……</translation>
    </message>
    <message>
        <location filename="rpcs3qt/log_viewer.cpp" line="378"/>
        <source>Ooops!</source>
        <translation>哎呀！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="26"/>
        <source>RPCS3</source>
    ...
    <message>
        ...
        <translation>启动 (S)Elf</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="282"/>
        <source>Utilities</source>
        <translation>实用工具</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="306"/>
        <source>View</source>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="322"/>
        <source>Game List Mode</source>
        <translation>游戏列表模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="329"/>
        <source>Game Categories</source>
        <translation>游戏类别</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="361"/>
        <source>Help</source>
        <translation>帮助</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="365"/>
        <source>Language</source>
        <translation>语言</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="396"/>
        <source>Show tool bar</source>
        <translation>显示工具栏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="434"/>
        <source>Boot SELF/ELF</source>
        <translation>启动 SELF/ELF</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="439"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="454"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="457"/>
        <source>Install application from a .pkg file</source>
        <oldsource>Install application from pkg file</oldsource>
        <translation>从一个 .pkg 文件安装应用程序</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="462"/>
        <source>Install Firmware</source>
        <translation>安装固件</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="465"/>
        <source>Install firmware from PS3UPDAT.PUP</source>
        <translation>从 PS3UPDAT.PUP 安装固件</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="477"/>
        <location filename="rpcs3qt/main_window.cpp" line="1843"/>
        <location filename="rpcs3qt/main_window.cpp" line="1866"/>
        <source>Pause</source>
        <translation>暂停</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="480"/>
        <location filename="rpcs3qt/main_window.ui" line="961"/>
        <source>Start emulation</source>
        <oldsource>Start Emulation</oldsource>
        <translation>开始模拟</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="492"/>
        <location filename="rpcs3qt/main_window.ui" line="970"/>
    ...
    <message>
        ...
        <location filename="rpcs3qt/main_window.ui" line="973"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="508"/>
        <source>CPU</source>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="519"/>
    ...
    <message>
        ...
        <location filename="rpcs3qt/main_window.ui" line="527"/>
        <location filename="rpcs3qt/main_window.ui" line="994"/>
        <source>Pads</source>
        <translation>手柄</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="530"/>
        <location filename="rpcs3qt/main_window.ui" line="997"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="551"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="559"/>
        <source>Advanced</source>
        <translation>高阶</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="567"/>
        <source>Emulator</source>
        <translation>模拟器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="570"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="578"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="589"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="611"/>
        <source>Exit the application.</source>
        <oldsource>Exit the application</oldsource>
        <translation>退出应用程序。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="619"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="654"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="670"/>
        <source>RSX Debugger</source>
        <translation>RSX 调试器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="675"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="693"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="701"/>
        <source>Show Debugger</source>
        <translation>显示调试器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="709"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="727"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="756"/>
        <source>RAP Files</source>
        <translation>RAP 文件</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="761"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="771"/>
        <source>Virtual File System</source>
        <translation>虚拟文件系统</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="776"/>
        <source>List Clear</source>
        <translation>列表清理</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="784"/>
        <source>List Freeze</source>
        <translation>列表冻结</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="792"/>
        <source>Tiny</source>
        <translation>极小</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="803"/>
        <source>Small</source>
        <translation>小</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="811"/>
        <source>Medium</source>
        <translation>中</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="819"/>
        <source>Large</source>
        <translation>大</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="830"/>
        <source>List View</source>
        <translation>列表视图</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="838"/>
        <source>Grid View</source>
        <translation>网格视图</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="850"/>
        <location filename="rpcs3qt/main_window.cpp" line="173"/>
        <location filename="rpcs3qt/main_window.cpp" line="1919"/>
        <location filename="rpcs3qt/main_window.cpp" line="3112"/>
        <location filename="rpcs3qt/main_window.cpp" line="3135"/>
        <source>Restart</source>
        <translation>重启</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="861"/>
        <location filename="rpcs3qt/main_window.cpp" line="2901"/>
        <source>HDD Games</source>
        <translation>硬盘游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="872"/>
        <location filename="rpcs3qt/main_window.cpp" line="2902"/>
        <source>Disc Games</source>
        <translation>光盘游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="883"/>
        <location filename="rpcs3qt/main_window.cpp" line="2903"/>
        <source>PS1 Games</source>
        <translation>PS1 游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="894"/>
        <location filename="rpcs3qt/main_window.cpp" line="2904"/>
        <source>PS2 Games</source>
        <translation>PS2 游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="905"/>
        <location filename="rpcs3qt/main_window.cpp" line="2905"/>
        <source>PSP Games</source>
        <translation>PSP 游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="916"/>
        <location filename="rpcs3qt/main_window.cpp" line="2906"/>
        <source>Home</source>
        <translation>主页</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="927"/>
        <location filename="rpcs3qt/main_window.cpp" line="2907"/>
        <source>Audio/Video</source>
        <translation>音频/视频</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="938"/>
        <location filename="rpcs3qt/main_window.cpp" line="2908"/>
        <source>Game Data</source>
        <translation>游戏数据</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="949"/>
        <location filename="rpcs3qt/main_window.cpp" line="2909"/>
        <source>Unknown</source>
        <translation>未知</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="958"/>
        <source>Start</source>
        <translation>开始</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="982"/>
        <source>Config</source>
        <translation>配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="985"/>
        <source>Configure the emulator</source>
        <translation>配置模拟器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1006"/>
        <source>FullScr</source>
        <translation>全屏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1009"/>
        <source>Toggle fullscreen</source>
        <translation>切换全屏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1018"/>
        <source>List</source>
        <translation>列表</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1021"/>
        <source>Switch to list mode</source>
        <translation>切换至列表模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1030"/>
        <source>Grid</source>
        <translation>网格</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1033"/>
        <source>Switch to grid mode</source>
        <translation>切换至网格模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1042"/>
        <source>Refresh</source>
        <translation>刷新</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1045"/>
        <source>Refresh gamelist</source>
        <translation>刷新游戏列表</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1054"/>
        <source>Open</source>
    ...
    <message>
        ...
        <location filename="rpcs3qt/main_window.cpp" line="2910"/>
        <source>Other</source>
        <translation>其他</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Create PPU/SPU Caches</source>
        <oldsource>Create PPU Caches</oldsource>
        <translation>创建 PPU/SPU 缓存</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1114"/>
        <source>Remove SPU Caches</source>
        <translation>移除 SPU 缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1119"/>
        <source>Remove Shader Caches</source>
        <translation>移除着色器缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1124"/>
        <source>Remove Custom Pad Configurations</source>
        <translation>移除自定义手柄配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1129"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1152"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1188"/>
        <source>Game Patches</source>
        <translation>游戏补丁</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1193"/>
        <source>RPCN</source>
        <translation>RPCN</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1204"/>
        <source>Configure IPC</source>
        <translation>配置 IPC</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1209"/>
        <source>Log Viewer</source>
        <translation>日志查看器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1220"/>
        <source>Show Custom Icons</source>
        <translation>显示自定义图标</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1231"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1241"/>
        <source>Patch Creator</source>
        <translation>补丁创作器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1246"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1267"/>
        <source>Check Config</source>
        <translation>检查配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1272"/>
        <source>Shortcuts</source>
        <translation>快捷方式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1280"/>
        <source>System Commands</source>
        <translation>系统指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1285"/>
        <source>Buzz</source>
        <translation>Buzz</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1290"/>
        <source>GHLtar</source>
        <translation>GHLtar</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1295"/>
        <source>Turntable</source>
        <translation>转盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1300"/>
        <source>USIO</source>
        <translation>USIO</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.ui" line="1305"/>
        <source>PS Move (Fake)</source>
        <translation>PS Move（伪造）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="145"/>
        <location filename="rpcs3qt/main_window.cpp" line="1896"/>
        <location filename="rpcs3qt/main_window.cpp" line="1958"/>
        <location filename="rpcs3qt/main_window.cpp" line="3116"/>
        <location filename="rpcs3qt/main_window.cpp" line="3126"/>
        <location filename="rpcs3qt/main_window.cpp" line="3139"/>
        <source>Play %0</source>
        <translation>游玩 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="145"/>
        <location filename="rpcs3qt/main_window.cpp" line="1883"/>
        <location filename="rpcs3qt/main_window.cpp" line="1910"/>
        <location filename="rpcs3qt/main_window.cpp" line="1968"/>
        <location filename="rpcs3qt/main_window.cpp" line="3119"/>
        <source>Play</source>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="202"/>
        <source>Update Available!</source>
        <translation>有可用更新！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="204"/>
        <source>Download Update</source>
        <translation>下载更新</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="278"/>
        <source>Missing Firmware Detected!</source>
        <translation>检测到固件缺失！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="279"/>
...
&lt;br&gt;关于如何获得必需固件的更多信息，请阅读 &lt;a %0 href=&quot;https://rpcs3.net/quickstart&quot;&gt;快速入门指南&lt;/a&gt;。</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="285"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="457"/>
        <source>Unknown error.</source>
        <translation>未知错误。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="460"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="467"/>
        <source>Booting failed: %1 %2</source>
        <translation>启动失败：%1 %2</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="511"/>
        <location filename="rpcs3qt/main_window.cpp" line="557"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="620"/>
        <source>Select Game Folder</source>
        <translation>选择游戏文件夹</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="655"/>
        <source>Select RSX Capture</source>
        <translation>选择 RSX 捕获</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="773"/>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="809"/>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="953"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1101"/>
        <location filename="rpcs3qt/main_window.cpp" line="1106"/>
        <location filename="rpcs3qt/main_window.cpp" line="1603"/>
        <source>Success!</source>
        <translation>成功！</translation>
    </message>
    <message>
...
%1！</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1208"/>
        <source>Failure!</source>
        <translation>失败！</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <location filename="rpcs3qt/main_window.cpp" line="1274"/>
        <location filename="rpcs3qt/main_window.cpp" line="1299"/>
        <source>Extraction Directory</source>
        <translation>「提取文件」目录</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1242"/>
        <source>Select PS3UPDAT.PUP To Install</source>
        <translation>选择 PS3UPDAT.PUP 来安装</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1246"/>
        <location filename="rpcs3qt/main_window.cpp" line="1495"/>
        <location filename="rpcs3qt/main_window.cpp" line="1505"/>
        <location filename="rpcs3qt/main_window.cpp" line="1516"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1267"/>
        <source>Select PS3UPDAT.PUP To extract</source>
        <translation>选择 PS3UPDAT.PUP 来提取</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1292"/>
...
请稍等……</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1325"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1413"/>
    ...
    <message>
        ...
        <location filename="rpcs3qt/main_window.cpp" line="1430"/>
        <location filename="rpcs3qt/main_window.cpp" line="1469"/>
        <location filename="rpcs3qt/main_window.cpp" line="1490"/>
...
And is logged with some sceNpDrm* functions when the game/application which owns &quot;%0&quot; is running.</source>
        <translation>提示：KLIC (KLicense key) 是一个 16 字节长的字符串。（32 个十六进制字符，在日志信息中会以 &quot;KLIC=0x&quot; 为前缀）
当拥有 &quot;%0&quot; 的游戏以或应用程序正在运行时，使用一些 sceNpDrm* 的函数进行记录。（看不懂）
</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1652"/>
        <source>Hexadecimal value.</source>
        <translation>十六进制值。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2400"/>
        <source>Failed to locate log</source>
        <translation>定位日志失败</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2400"/>
...
请确保 RPCS3.log 和 RPCS3.log.gz 是可写入的，且能够在无权限问题的情形下被（成功）创建。</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2457"/>
        <location filename="rpcs3qt/main_window.cpp" line="2480"/>
        <source>Select RPCS3&apos;s log saving location (saving %0)</source>
        <translation>选择 RPCS3 的日志保存位置（保存 %0）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2543"/>
        <source>Select Disc Game Folder</source>
        <translation>选择光盘游戏文件夹</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2554"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2741"/>
        <source>Select rpcs3.log or config.yml</source>
        <translation>选择 rpcs3.log 或 config.yml</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2761"/>
...
继续安装流程？</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="733"/>
...
DLC</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="785"/>
        <source>
Update</source>
...
更新</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="790"/>
        <source>
%0</source>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="800"/>
        <source>
Version %0</source>
...
版本 %0</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="805"/>
        <source>Changelog:
%0</source>
        <oldsource>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="979"/>
        <source>v.%0</source>
...
请把 RPCS3 添加到你的防病毒软件的白名单中，或使用更佳的防病毒软件。</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1339"/>
...
请把 RPCS3 添加到你的防病毒软件的白名单中，或使用更佳的防病毒软件。</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1651"/>
...
%0</translation>
    ...
    <message>
        ...
        <location filename="rpcs3qt/main_window.cpp" line="1853"/>
        <location filename="rpcs3qt/main_window.cpp" line="1915"/>
        <location filename="rpcs3qt/main_window.cpp" line="3109"/>
        <location filename="rpcs3qt/main_window.cpp" line="3132"/>
        <source>Restart %0</source>
        <translation>重启 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1829"/>
        <location filename="rpcs3qt/main_window.cpp" line="1854"/>
        <source>Pause %0</source>
        <translation>暂停 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1830"/>
        <location filename="rpcs3qt/main_window.cpp" line="1855"/>
        <source>Stop %0</source>
        <translation>停止 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1874"/>
        <source>Resume %0</source>
        <translation>恢复 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1840"/>
        <location filename="rpcs3qt/main_window.cpp" line="1863"/>
        <source>&amp;Pause</source>
        <translation>&amp;暂停</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1880"/>
        <source>&amp;Resume</source>
        <translation>&amp;恢复</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="1898"/>
        <location filename="rpcs3qt/main_window.cpp" line="1965"/>
        <source>&amp;Play</source>
        <translation>&amp;游玩</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2065"/>
        <location filename="rpcs3qt/main_window.cpp" line="2110"/>
        <location filename="rpcs3qt/main_window.cpp" line="2176"/>
        <source>Ctrl+%1</source>
        <translation>Ctrl+%1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2327"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="2752"/>
...
仍要检查？</translation>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="3285"/>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="3289"/>
        <source>Error</source>
        <translation>错误</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/main_window.cpp" line="3300"/>
        <source>Confirm Removal</source>
        <translation>确认移除</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="64"/>
        <source>Memory Viewer</source>
        <translation>内存查看器</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="87"/>
        <source>Address</source>
        <translation>地址</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="100"/>
        <source>Words</source>
        <translation>字</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="117"/>
        <source>%0</source>
        <translation>%0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="128"/>
    ...
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="183"/>
        <source>Mode</source>
        <translation>模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="202"/>
        <source>Tools</source>
        <translation>工具</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="204"/>
        <source>View
image</source>
        <translation>查看
图像</translation>
    ...
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="294"/>
        <source>Case Insensitive</source>
        <translation>不区分大小写</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="296"/>
...
警告：这可能会降低搜索的性能。</translation>
    ...
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="300"/>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="344"/>
        <source>Select search mode(s)..</source>
        <translation>选择搜索模式……</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="301"/>
        <source>Deselect All Modes</source>
        <translation>取消选择所有模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="302"/>
    ...
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="304"/>
        <source>Double</source>
        <translation>Double</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="305"/>
        <source>Float</source>
        <translation>Float</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="306"/>
        <source>Instruction</source>
        <translation>指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="307"/>
        <source>RegEx Instruction</source>
        <translation>RegEx 指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/memory_viewer_panel.cpp" line="309"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/msg_dialog_frame.cpp" line="17"/>
    ...
    <message>
        ...
        <translation>错误对话框</translation>
    </message>
    <message>
        <location filename="rpcs3qt/msg_dialog_frame.cpp" line="66"/>
        <source>&amp;Yes</source>
        <translation>&amp;是</translation>
    </message>
    <message>
        <location filename="rpcs3qt/msg_dialog_frame.cpp" line="67"/>
        <source>&amp;No</source>
        <translation>&amp;否</translation>
    </message>
    <message>
        <location filename="rpcs3qt/msg_dialog_frame.cpp" line="101"/>
        <source>&amp;OK</source>
        <translation>&amp;确定</translation>
    </message>
</context>
...
<context>
    ...
    <message>
        ...
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2000"/>
        <source>Up</source>
    ...
    <message>
        ...
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2049"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2228"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2303"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2488"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2563"/>
        <source>Left</source>
    ...
    <message>
        ...
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2080"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2255"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2333"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2515"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2593"/>
        <source>Right</source>
    ...
    <message>
        ...
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2141"/>
        <source>Down</source>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="767"/>
        <source>Trigger Thresholds</source>
        <translation>扳机阈值</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="824"/>
        <source>Enable Vibration</source>
        <translation>启用振动</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="842"/>
        <source>Large</source>
        <translation>大</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="852"/>
        <source>Small</source>
        <translation>小</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="862"/>
        <source>Switch</source>
        <translation>切换</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="901"/>
        <source>Mouse Acceleration</source>
        <translation>鼠标加速</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="919"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1000"/>
        <source>x</source>
        <translation>x</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="949"/>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1026"/>
        <source>y</source>
        <translation>y</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="982"/>
        <source>Mouse Deadzone</source>
        <translation>鼠标死区</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1581"/>
        <source>Device Class</source>
        <translation>设备类别</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1129"/>
        <source>L1</source>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="713"/>
        <source>Toggle</source>
        <translation>切换</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2363"/>
        <source>Stick Preview</source>
        <translation>摇杆预览</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2381"/>
        <source>Show Emulated Values</source>
        <translation>显示模拟值</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1055"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1160"/>
        <source>L2</source>
        <translation>L2</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1178"/>
        <source>R</source>
        <translation>R</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1213"/>
        <source>Select</source>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1390"/>
        <source>E</source>
        <translation>E</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1403"/>
        <source>R2</source>
        <translation>R2</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1421"/>
        <source>T</source>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1517"/>
        <source>F</source>
        <translation>F</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1530"/>
        <source>R3</source>
        <translation>R3</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1548"/>
        <source>G</source>
        <translation>G</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1614"/>
        <source>Battery status and LED</source>
        <translation>电池状态与 LED</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1654"/>
        <source>LED Settings</source>
        <translation>LED 设置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1682"/>
        <source>Description</source>
        <translation>描述</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1717"/>
        <source>Face Buttons</source>
        <translation>正面按键</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1763"/>
        <source>Triangle</source>
        <translation>三角键</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1812"/>
        <source>Square</source>
        <translation>方形键</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1830"/>
        <source>Z</source>
        <translation>Z</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1843"/>
        <source>Circle</source>
        <translation>圆形键</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1861"/>
        <source>C</source>
        <translation>C</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1904"/>
        <source>Cross</source>
        <translation>叉形键</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1922"/>
        <source>X</source>
        <translation>X</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="1954"/>
    ...
    <message>
        ...
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2470"/>
        <source>Stick Multipliers</source>
        <translation>摇杆倍率</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2285"/>
        <source>Squircle Values</source>
        <translation>方圆形值</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2391"/>
        <source>Analog Stick Deadzones</source>
        <oldsource>Analog Deadzones</oldsource>
        <translation>模拟摇杆死区</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.ui" line="2545"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="85"/>
        <source>Gamepad Settings</source>
        <translation>游戏手柄设置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="125"/>
        <source>Player %0</source>
        <translation>玩家 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1682"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1692"/>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1697"/>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1702"/>
        <source>Error</source>
        <translation>错误</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="178"/>
        <source>Guitar</source>
        <translation>吉他</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="179"/>
        <source>Drum</source>
        <translation>鼓</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="180"/>
        <source>DJ</source>
        <translation>DJ</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="181"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="322"/>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1302"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1515"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1662"/>
        <source>Guitar Hero</source>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1855"/>
        <source>Warning!</source>
        <translation>警告！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1856"/>
    ...
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1890"/>
        <source>Null</source>
        <translation>空</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1891"/>
        <source>Keyboard</source>
        <translation>键盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1892"/>
        <source>DualShock 3</source>
        <translation>DualShock 3</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1893"/>
        <source>DualShock 4</source>
        <translation>DualShock 4</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1894"/>
        <source>DualSense</source>
        <translation>DualSense</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1896"/>
        <source>XInput</source>
        <translation>XInput</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1897"/>
        <source>MMJoystick</source>
        <translation>MMJoystick</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1900"/>
        <source>SDL</source>
        <translation>SDL</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pad_settings_dialog.cpp" line="1903"/>
        <source>Evdev</source>
...
<context>
    ...
    <message>
        ...
        <location filename="rpcs3qt/patch_creator_dialog.ui" line="72"/>
        <source>Value</source>
    ...
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.ui" line="145"/>
        <source>Group</source>
    ...
    <message>
        ...
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="394"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="139"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="250"/>
        <source>Offset invalid!</source>
        <translation>偏移量无效！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="250"/>
...
The offset has to be a hexadecimal number with 8 digits at most.</source>
        <translation>补丁偏移量无效。
偏移量最大只能是一个八位的十六进制数字。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="400"/>
        <source>Validation Failed</source>
        <translation>校验失败</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="458"/>
...
不允许导出无效的补丁。</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="462"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_creator_dialog.cpp" line="510"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="951"/>
        <source>Collapse All</source>
        <translation>折叠全部</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="947"/>
    ...
    <message>
        ...
        <location filename="rpcs3qt/patch_manager_dialog.ui" line="277"/>
        <source>N/A</source>
        <translation>N/A</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="855"/>
        <source>Show Patch File</source>
        <translation>显示补丁文件</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="866"/>
        <source>Remove Patch</source>
        <translation>移除补丁</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="870"/>
        <source>Remove Patch?</source>
        <translation>移除补丁？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="871"/>
...
该操作会立即进行且不可撤销！</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="882"/>
        <source>Success</source>
        <translation>成功</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="888"/>
        <source>Failure</source>
        <translation>失败</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="902"/>
        <source>Collapse</source>
        <translation>折叠</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="913"/>
        <source>Expand Children</source>
        <translation>展开子节点</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="923"/>
        <source>Collapse Children</source>
        <translation>折叠子节点</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="936"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="997"/>
        <source>Validate</source>
        <translation>校验</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1033"/>
        <source>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1042"/>
...
%2%3</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1048"/>
...
%0</translation>
    ...
    <message>
        ...
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1282"/>
        <source>%0</source>
        <translation>%0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1140"/>
        <source>Downloading latest patches</source>
        <translation>正在下载最新补丁</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1174"/>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1266"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1189"/>
...
你想更新吗？</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1275"/>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1279"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="227"/>
        <source>Incompatible patches detected</source>
        <translation>检测到不兼容的补丁</translation>
    </message>
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="228"/>
...
请确保位于 &quot;%0&quot; 中的所有补丁包含了补丁管理器版本 %1 要求的适当格式。</translation>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1053"/>
    ...
    <message>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1063"/>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1068"/>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1275"/>
        <location filename="rpcs3qt/patch_manager_dialog.cpp" line="1280"/>
        <source>Validation failed</source>
        <translation>校验失败</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="61"/>
        <source>DLC</source>
        <comment>Package type info (DLC)</comment>
        <translation>DLC</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="65"/>
        <source>Update</source>
        <comment>Package type info (Update)</comment>
        <translation>更新</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="71"/>
        <source>%0</source>
        <comment>Package type info</comment>
        <translation>%0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="77"/>
        <source>v.%0</source>
...
%0</translation>
    ...
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="92"/>
        <source>&lt;b&gt;%0&lt;/b&gt; (%2)</source>
        <comment>Package text</comment>
        <translation>&lt;b&gt;%0&lt;/b&gt; (%2)</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="111"/>
        <source>Install</source>
        <translation>安装</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="143"/>
        <source>Move selected item up</source>
        <translation>上移所选项目</translation>
    </message>
    <message>
        <location filename="rpcs3qt/pkg_install_dialog.cpp" line="148"/>
        <source>Move selected item down</source>
        <translation>下移所选项目</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/render_creator.cpp" line="79"/>
        <source>Vulkan Check Timeout</source>
        <translation>Vulkan 检查超时</translation>
    </message>
    <message>
        <location filename="rpcs3qt/render_creator.cpp" line="80"/>
...
选择「忽略」会在没有 Vulkan 支持下启动模拟器。</translation>
    ...
    <message>
        <location filename="rpcs3qt/render_creator.cpp" line="112"/>
        <source>Vulkan is not supported on this Mac.
No graphics will be rendered.</source>
        <translation>此 Mac 不支持 Vulkan。
不会渲染任何图形。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/save_data_info_dialog.cpp" line="70"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="67"/>
        <source>Save Manager</source>
        <translation>保存管理器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="90"/>
        <source>Icon</source>
        <translation>图标</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="97"/>
        <source>Icon size:</source>
        <translation>图标尺寸：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="102"/>
        <source>&amp;Close</source>
        <translation>&amp;关闭</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="531"/>
...
%1？</translation>
    ...
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="554"/>
        <source>&amp;Remove</source>
        <translation>&amp;移除</translation>
    </message>
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="555"/>
        <source>&amp;Open Save Directory</source>
        <translation>&amp;打开保存目录</translation>
    </message>
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="609"/>
        <source>%1 items selected</source>
        <translation>%1 项已选择</translation>
    </message>
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="637"/>
        <source>Last modified: %1</source>
        <translation>上次修改：%1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/save_manager_dialog.cpp" line="638"/>
        <source>Details:
</source>
        <translation>详情：
</translation>
...
<context>
    ...
    <message>
        ...
        <translation>选取朋友来发消息：</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>你必须选择一个朋友！</translation>
    </message>
</context>
<context>
    <name>settings_dialog</name>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="23"/>
        <source>Settings</source>
        <translation>设置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="61"/>
        <source>CPU</source>
        <translation>CPU</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="71"/>
        <source>PPU Decoder</source>
        <translation>PPU 解码器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="94"/>
        <source>SPU Decoder</source>
        <translation>SPU 解码器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="169"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="930"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1782"/>
        <source>Additional Settings</source>
        <translation>附加设置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="175"/>
        <source>Enable SPU loop detection</source>
        <oldsource>Lower SPU thread priority</oldsource>
        <translation>启用 SPU 循环检测</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="260"/>
        <source>TSX Instructions</source>
        <translation>TSX 指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="278"/>
        <source>SPU Block Size</source>
        <translation>SPU 块大小</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>线程调度器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="362"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1020"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1556"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1860"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2113"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2306"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2839"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="3611"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4015"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4378"/>
        <source>Description</source>
        <translation>描述</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="368"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1026"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1562"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="1866"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2119"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2312"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2845"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="3617"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4021"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4384"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="391"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2601"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4055"/>
        <source>GPU</source>
        <translation>GPU</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="401"/>
        <source>Renderer</source>
        <translation>渲染器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="413"/>
        <source>Graphics Device</source>
        <translation>图形设备</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="440"/>
        <source>Aspect Ratio</source>
        <translation>宽高比</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="452"/>
        <source>Framelimit</source>
        <translation>帧数限制</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="482"/>
        <source>Anisotropic Filter</source>
        <translation>各向异性过滤</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="494"/>
        <source>Anti-Aliasing</source>
        <translation>抗锯齿</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="524"/>
        <source>ZCULL Accuracy</source>
        <translation>ZCULL 准确性</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="583"/>
        <source>Default Resolution</source>
        <translation>默认分辨率</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="603"/>
        <source>Resolution Scale (Disable Strict Mode)</source>
        <translation>分辨率缩放（禁用严格模式）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="627"/>
        <source>50</source>
        <translation>50</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="644"/>
        <source>800</source>
        <translation>800</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="212"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="656"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="793"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="824"/>
        <source>0</source>
        <translation>0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="222"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="666"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="727"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="834"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2504"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2579"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2744"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="2787"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="3261"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4329"/>
        <source>Reset</source>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="706"/>
        <source>1024</source>
        <translation>1024</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="717"/>
        <source>1x1</source>
    ...
    <message>
        ...
        <translation>RCAS 锐化强度</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="813"/>
        <source>100</source>
        <translation>100</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="881"/>
        <source>Shader Mode</source>
        <translation>着色器模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="918"/>
        <source>Number of Shader Compiler Threads</source>
        <translation>着色器编译器线程数量</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="939"/>
        <source>Write Color Buffers</source>
        <translation>写入颜色缓冲</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="946"/>
        <source>Strict Rendering Mode</source>
        <translation>严格渲染模式</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>禁用顶点缓存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="967"/>
        <source>Multithreaded RSX</source>
        <translation>多线程的 RSX</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="974"/>
        <source>Asynchronous Texture Streaming</source>
        <translation>异步纹理流</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1049"/>
        <source>Audio</source>
        <translation>音频</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1059"/>
        <source>Audio Out</source>
        <translation>音频输出</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1071"/>
        <source>Audio Format</source>
        <oldsource>Audio Channels</oldsource>
        <translation>音频格式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1096"/>
    ...
    <message>
        ...
        <translation>转换为 16 位</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1203"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1276"/>
        <source>Enable Buffering</source>
        <translation>启用缓冲</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1298"/>
        <source>Audio Buffer Duration: 0ms</source>
        <translation>音频缓冲时长：0ms</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1321"/>
        <source>Enable Time Stretching</source>
        <translation>启用时间拉伸</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1343"/>
        <source>Time Stretching Threshold: 0%</source>
        <translation>时间拉伸阈值：0%</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1389"/>
        <source>Microphone Settings</source>
        <translation>话筒设置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1397"/>
        <source>Microphone Type:</source>
        <translation>话筒类型：</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1653"/>
        <source>Keyboard Handler</source>
        <translation>键盘处理程序</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1677"/>
        <source>Camera Input</source>
        <translation>相机输入</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1605"/>
        <source>Move Handler</source>
        <translation>Move 处理程序</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1629"/>
        <source>Mouse Handler</source>
        <translation>鼠标处理程序</translation>
    </message>
    <message>
        ...
        <translation>Buzz! 模拟控制器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1617"/>
        <source>DJ Hero Emulated Turntable</source>
        <oldsource>DJ Hero emulated turntable</oldsource>
        <translation>DJ Hero 模拟转盘</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1191"/>
        <source>Music Handler</source>
        <translation>音乐处理程序</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1167"/>
        <source>Audio Provider</source>
        <translation>音频提供者</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1713"/>
        <source>Camera Handler</source>
        <translation>相机处理程序</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1593"/>
        <source>Guitar Hero Live Emulated Guitar</source>
        <oldsource>Guitar Hero Live emulated guitar</oldsource>
        <translation>Guitar Hero Live 模拟吉他</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1701"/>
        <source>Camera</source>
        <translation>相机</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1889"/>
        <source>System</source>
        <translation>系统</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1897"/>
        <source>Console Language</source>
        <translation>主机语言</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1909"/>
        <source>Keyboard Type</source>
        <translation>键盘类型</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1921"/>
        <source>Homebrew</source>
        <translation>Homebrew</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1927"/>
        <source>Enable /host_root/</source>
        <translation>启用 /host_root/</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1941"/>
        <source>Console Region</source>
        <translation>主机区域</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1953"/>
        <source>Console Time</source>
        <translation>主机时间</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1998"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2150"/>
        <source>Network Configuration</source>
        <translation>网络配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2156"/>
        <source>Network Status</source>
        <translation>网络状态</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2168"/>
        <source>DNS</source>
        <translation>DNS</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2187"/>
        <source>IP/Hosts switches</source>
        <translation>IP/Hosts 切换</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2251"/>
        <source>PSN Configuration</source>
        <translation>PSN 配置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2257"/>
        <source>PSN Status</source>
        <translation>PSN 状态</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2335"/>
        <source>Advanced</source>
        <translation>高阶</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2351"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="4170"/>
        <source>Core</source>
        <translation>Core</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2357"/>
        <source>Debug Console Mode</source>
        <translation>调试主机模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2364"/>
        <source>Accurate DFMA</source>
        <oldsource>Accurate LLVM DFMA</oldsource>
        <translation>精准 DFMA</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2443"/>
        <source>Sleep Timers Accuracy</source>
        <translation>睡眠定时器准确性</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2461"/>
        <source>Maximum Number of SPURS Threads</source>
        <translation>SPURS 线程最大数量</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2536"/>
        <source>Firmware Libraries</source>
        <translation>固件库</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2665"/>
        <source>Vulkan Queue Scheduler</source>
        <translation>Vulkan 队列调度器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2719"/>
        <source>Driver Wake-Up Delay</source>
        <translation>驱动唤醒延迟</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2762"/>
        <source>VBlank Frequency</source>
        <translation>VBlank 频率</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2777"/>
        <source>60 Hz</source>
        <translation>60 Hz</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2796"/>
        <source>VBlank NTSC Fixup</source>
        <translation>VBlank NTSC 修正</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2479"/>
        <source>Clocks Scale</source>
        <translation>时钟尺度</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>着色器质量</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="551"/>
        <source>3D</source>
        <translation>3D</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1155"/>
        <source>Audio Device</source>
        <translation>音频设备</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1725"/>
        <source>Emulated MIDI Device 1</source>
        <oldsource>Emulated Midi device 1</oldsource>
        <translation>模拟 MIDI 设备 1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1744"/>
        <source>Emulated MIDI Device 3</source>
        <oldsource>Emulated Midi device 3</oldsource>
        <translation>模拟 MIDI 设备 3</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1763"/>
        <source>Emulated MIDI Device 2</source>
        <oldsource>Emulated Midi device 2</oldsource>
        <translation>模拟 MIDI 设备 2</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1788"/>
        <source>Enable Background Input</source>
        <translation>启用后台输入</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1795"/>
        <source>Keep Pads Connected</source>
        <translation>保持手柄连接</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="1802"/>
        <source>Show PS Move Cursor</source>
        <translation>显示 PS Move 光标</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2206"/>
        <source>Bind address</source>
        <translation>绑定地址</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2225"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2494"/>
        <source>100%</source>
        <translation>100%</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2683"/>
        <source>RSX FIFO Accuracy</source>
        <translation>RSX FIFO 准确性</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2701"/>
        <source>Exclusive Fullscreen Mode</source>
        <translation>独占全屏模式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2868"/>
        <source>Emulator</source>
        <translation>模拟器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2878"/>
    ...
    <message>
        ...
        <translation>使用高精度 Z-Buffer</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4176"/>
        <source>Automatically start games after boot</source>
        <translation>启动后自动开始游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2940"/>
        <source>Start games in fullscreen mode</source>
        <oldsource>Start games in Fullscreen mode</oldsource>
        <translation>以全屏模式开始游戏</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>PPU/SPU LLVM 预编译</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>显示 PPU 编译提示</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2973"/>
        <source>Max LLVM Compile Threads</source>
        <translation>LLVM 编译最大线程数量</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2989"/>
        <source>Viewport</source>
        <translation>观察口</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="2995"/>
        <source>Ignore doubleclicks for Fullscreen</source>
        <translation>忽略双击全屏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3002"/>
        <source>Ignore keyboard hotkeys</source>
        <translation>忽略键盘快捷键</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>全屏时锁定鼠标光标</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3038"/>
        <source>Hide mouse cursor if idle</source>
        <translation>鼠标空闲后隐藏其光标</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3054"/>
        <source>ms</source>
        <translation>ms</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3091"/>
        <source>Resize game window on boot</source>
        <translation>启动时重定游戏视窗的尺寸</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3098"/>
        <source>Resize manually</source>
        <translation>手动重定尺寸</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3107"/>
        <source>Width</source>
        <translation>宽度</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3138"/>
        <source>Height</source>
        <translation>高度</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3180"/>
        <source>Shader Loading Screen</source>
        <translation>着色器加载屏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3186"/>
        <source>Allow custom background</source>
        <translation>允许自定义背景</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3193"/>
        <source>Background darkening:</source>
        <translation>背景暗化：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3207"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3258"/>
        <source>Reset the game window title to default</source>
        <translation>将游戏视窗标题重置为默认值</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3271"/>
        <source>Edit</source>
        <translation>编辑</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3287"/>
        <source>Performance Overlay</source>
        <translation>性能蒙层</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3293"/>
        <source>Enable performance overlay</source>
        <translation>启用性能蒙层</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3300"/>
        <source>Show framerate graph</source>
        <translation>展示帧率图表</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3307"/>
        <source>Show frametime graph</source>
        <translation>展示帧时间图表</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3329"/>
        <source>Detail Level:</source>
        <translation>详情等级：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3357"/>
        <source>Position:</source>
        <translation>位置：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3370"/>
        <source>Horizontal Margin:</source>
        <translation>水平边距：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3379"/>
        <location filename="rpcs3qt/settings_dialog.ui" line="3400"/>
        <source>Centered</source>
        <translation>居中</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3391"/>
        <source>Vertical Margin:</source>
        <translation>垂直边距：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3427"/>
        <source>Update Interval:</source>
        <translation>更新间隔：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3465"/>
        <source>Font Size: </source>
        <translation>字体大小：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3497"/>
        <source>Opacity:</source>
        <translation>不透明度：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3526"/>
        <source>Framerate datapoints:</source>
        <translation>帧率数据点集：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3555"/>
        <source>Frametime datapoints:</source>
        <translation>帧时间数据点集：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3640"/>
        <source>GUI</source>
        <translation>图形用户界面（GUI）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3650"/>
        <source>UI Stylesheets</source>
        <translation>UI 样式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3659"/>
        <source>Apply</source>
        <translation>应用</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3669"/>
        <source>UI Colors</source>
        <translation>UI 颜色</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3687"/>
    ...
    <message>
        ...
        <translation>保存管理器图标</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3708"/>
        <source>Trophy manager icons</source>
        <translation>奖杯管理器图标</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3738"/>
        <source>Log</source>
        <translation>日志</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3765"/>
    ...
    <message>
        ...
        <translation>展示重复按键对话框</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3895"/>
        <source>Show Restart Dialog</source>
        <translation>展示重启对话框</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3921"/>
        <source>Check for updates on startup</source>
        <translation>起动时检查更新</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3933"/>
        <source>Discord</source>
        <translation>Discord</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3939"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3969"/>
        <source>Installation ID</source>
        <translation>安装 ID</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3975"/>
        <source>UUID-placeholder</source>
        <translation>UUID 预留位置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="3985"/>
        <source>Create new ID</source>
        <translation>创建新 ID</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4044"/>
        <source>Debug</source>
        <translation>调试</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4064"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4113"/>
        <source>Force GPU Texture Scaling</source>
        <translation>强制 GPU 纹理缩放</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4120"/>
        <source>Log Shader Programs</source>
        <translation>着色器程序打日志</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4099"/>
        <source>Disable ZCull Occlusion Queries</source>
        <translation>禁用 ZCull 遮挡查询</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4085"/>
        <source>Disable Video Output</source>
        <translation>禁用视频输出</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4092"/>
        <source>Disable Vulkan Memory Allocator</source>
        <translation>禁用 Vulkan 内存分配器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4078"/>
    ...
    <message>
        ...
        <translation>严格纹理冲洗</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4294"/>
        <source>Accurate PPU 128 Reservations</source>
        <translation>精准 PPU 128 预留</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4306"/>
        <source>PPU Thread Count</source>
        <translation>PPU 线程计数</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.ui" line="4318"/>
        <source>LOD Bias Offset</source>
        <translation>LOD 倾斜偏移</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="141"/>
        <source>Settings: [%0] %1</source>
        <comment>Settings dialog</comment>
        <translation>设置：[%0] %1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="146"/>
        <source>Settings</source>
        <comment>Settings dialog</comment>
        <translation>设置</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="280"/>
...
每个选项很大程度上会因游戏和你的 CPU 而有所不同，推荐尝试每个选项以找出表现最佳者。</translation>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="294"/>
        <source>Auto</source>
        <comment>Preferred SPU threads</comment>
        <translation>自动</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="316"/>
        <source>Haswell/Broadwell TSX Warning</source>
        <translation>Haswell/Broadwell TSX 警告</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="353"/>
        <source>Not supported</source>
        <comment>Enable TSX</comment>
        <translation>不支持</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="354"/>
        <source>Unfortunately, your CPU model does not support this instruction set.</source>
        <oldsource>Unfortunately your CPU model does not support this instruction set.</oldsource>
        <comment>Enable TSX</comment>
        <translation>很遗憾，你的 CPU 型号不支持此指令集。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="505"/>
        <source>1280x720 (Recommended)</source>
        <comment>Resolution</comment>
        <translation>1280x720（推荐）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="533"/>
        <source>Auto</source>
        <comment>Anisotropic filter override</comment>
        <translation>自动</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="539"/>
        <source>%1x</source>
        <comment>Anisotropic filter override</comment>
        <translation>%1x</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="552"/>
        <source>Auto</source>
        <comment>Number of Shader Compiler Threads</comment>
        <translation>自动</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="659"/>
        <source>100% (1280x720) (Default)</source>
        <oldsource>100% (Default)</oldsource>
        <comment>Resolution scale</comment>
        <translation>100% (1280x720)（默认）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="661"/>
        <source>%1% (%2x%3)</source>
        <comment>Resolution scale</comment>
        <translation>%1% (%2x%3)</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="687"/>
        <source>%1x%1 (Default)</source>
        <comment>Minimum scalable dimension</comment>
        <translation>%1x%1（默认）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="689"/>
        <source>%1x%1</source>
        <comment>Minimum scalable dimension</comment>
        <translation>%1x%1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="711"/>
        <source>%1% (Default)</source>
        <translation>%1%（默认）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="713"/>
        <source>%1%</source>
        <translation>%1%</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="780"/>
        <source>Disabled</source>
        <comment>MSAA</comment>
        <translation>禁用</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="789"/>
        <source>Not needed for %0 renderer</source>
        <comment>Graphics adapter</comment>
        <translation>%0 渲染器不需要</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1135"/>
        <source>Master: %0 %</source>
        <comment>Master volume</comment>
        <translation>Master：%0 %</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1138"/>
        <source>Audio Buffer Duration: %0 ms</source>
        <comment>Audio buffer duration</comment>
        <translation>音频缓冲时长：%0 ms</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1141"/>
        <source>Time Stretching Threshold: %0 %</source>
        <comment>Time stretching threshold</comment>
        <translation>时间拉伸阈值：%0 %</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1365"/>
        <source>dd MMM yyyy HH:mm</source>
        <translation>yyyy年MMM月dd日 HH:mm</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1503"/>
    ...
    <message>
        ...
        <translation>精确（最慢）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="317"/>
        <source>
							&lt;p style=&quot;white-space: nowrap;&quot;&gt;
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="330"/>
        <source>TSX-FA Warning</source>
        <translation>TSX-FA 警告</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="331"/>
        <source>
							&lt;p style=&quot;white-space: nowrap;&quot;&gt;
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="556"/>
        <source>Approximate (Fast)</source>
        <translation>近似（快）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="557"/>
        <source>Relaxed (Fastest)</source>
        <translation>轻松（最快）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="959"/>
        <source>Default</source>
        <translation>默认</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="977"/>
        <source>Unknown device</source>
        <translation>未知设备</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1171"/>
        <source>None</source>
        <comment>Camera Device</comment>
        <translation>无</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1172"/>
        <source>Default</source>
        <comment>Camera Device</comment>
        <translation>默认</translation>
    </message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1542"/>
        <source>%0 %</source>
        <comment>Clocks scale</comment>
        <translation>%0 %</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1607"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1614"/>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1815"/>
        <source>Update Interval: %0 ms</source>
        <comment>Performance overlay update interval</comment>
        <translation>更新间隔：%0 ms</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1818"/>
        <source>Font Size: %0 px</source>
        <comment>Performance overlay font size</comment>
        <translation>字体大小：%0 px</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1821"/>
    ...
    <message>
        ...
        <translation>帧率数据点集：%0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1827"/>
        <source>Frametime datapoints: %0</source>
        <comment>Frametime graph datapoints</comment>
        <translation>帧时间数据点集：%0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1830"/>
        <source>Background darkening: %0 %</source>
        <comment>Shader load background darkening</comment>
        <translation>背景暗化：%0 %</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1841"/>
        <source>px</source>
        <comment>Performance overlay margin y</comment>
        <translation>px</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1954"/>
        <source>My Game</source>
        <comment>Game window title</comment>
        <translation>我的游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1989"/>
        <source>GPU Model</source>
        <comment>Game window title</comment>
        <translation>GPU 型号</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1990"/>
        <source>CPU Model</source>
        <comment>Game window title</comment>
        <translation>CPU 型号</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1991"/>
        <source>Thread Count</source>
        <comment>Game window title</comment>
        <translation>线程计数</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1992"/>
        <source>System Memory</source>
        <comment>Game window title</comment>
        <translation>系统内存</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1993"/>
        <source>Framerate</source>
        <comment>Game window title</comment>
        <translation>帧率</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1994"/>
        <source>Renderer</source>
        <comment>Game window title</comment>
        <translation>渲染器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1995"/>
        <source>Title</source>
        <comment>Game window title</comment>
        <translation>作品</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="1996"/>
        <source>Title ID</source>
        <comment>Game window title</comment>
        <translation>作品 ID</translation>
    </message>
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2007"/>
        <source>Glossary:
...
%1
    ...
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2091"/>
        <source>Error</source>
        <translation>错误</translation>
    </message>
    <message>
        ...
        <translation>创建新安装 ID 失败！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2154"/>
        <source>Yes</source>
        <comment>Updates</comment>
        <translation>是</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2155"/>
        <source>Background</source>
        <comment>Updates</comment>
        <translation>后台</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2156"/>
        <source>Automatic</source>
        <comment>Updates</comment>
        <translation>自动</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2157"/>
        <source>No</source>
        <comment>Updates</comment>
        <translation>否</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2238"/>
        <source>Choose gamelist icon color</source>
        <comment>Settings: color dialog</comment>
        <translation>选取游戏列表图标颜色</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2242"/>
        <source>Choose save manager icon color</source>
        <comment>Settings: color dialog</comment>
        <translation>选取保存管理器图标颜色</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2246"/>
        <source>Choose trophy manager icon color</source>
        <comment>Settings: color dialog</comment>
        <translation>选取奖杯管理器图标颜色</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2345"/>
        <source>Always Enabled</source>
        <comment>Accurate PPU 128 Reservations</comment>
        <translation>始终启用</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2346"/>
        <source>Disabled</source>
        <comment>Accurate PPU 128 Reservations</comment>
        <translation>禁用</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2408"/>
        <source>None</source>
        <comment>Stylesheets</comment>
        <translation>无</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2409"/>
        <source>Default (Bright)</source>
        <comment>Stylesheets</comment>
        <translation>默认（明亮）</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2468"/>
        <source>Remove obsolete settings?</source>
        <translation>移除淘汰的设置项？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/settings_dialog.cpp" line="2469"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/shortcut_dialog.ui" line="14"/>
        <source>Shortcuts</source>
        <translation>快捷方式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_dialog.ui" line="22"/>
        <source>Main Window Shortcuts</source>
        <translation>主视窗快捷方式</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_dialog.ui" line="50"/>
        <source>Game Window Shortcuts</source>
        <translation>游戏视窗快捷方式</translation>
    </message>
</context>
<context>
    <name>shortcut_settings</name>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="40"/>
        <source>Start</source>
        <translation>开始</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="41"/>
        <source>Stop</source>
        <translation>停止</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="42"/>
        <source>Pause</source>
        <translation>暂停</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="43"/>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="56"/>
        <source>Restart</source>
        <translation>重启</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="44"/>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="48"/>
        <source>Toggle Fullscreen</source>
        <translation>切换为全屏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="45"/>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="49"/>
        <source>Exit Fullscreen</source>
        <translation>退出全屏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="46"/>
        <source>Refresh</source>
        <translation>刷新</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>添加日志标记</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="51"/>
        <source>Mouse lock</source>
        <translation>鼠标锁定</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="52"/>
        <source>Start/Stop Recording</source>
        <translation>开始/停止录制</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>暂停/开玩</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="55"/>
        <source>Savestate</source>
        <translation>存档</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="57"/>
        <source>RSX Capture</source>
        <translation>RSX 捕获</translation>
    </message>
    <message>
        <location filename="rpcs3qt/shortcut_settings.cpp" line="58"/>
        <source>Toggle Framelimit</source>
        <translation>切换为帧数限制</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>小龙斯派罗创作器</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>输入的 ID 无效！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="615"/>
    ...
    <message>
        ...
        <translation>创建小龙斯派罗文件失败！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="639"/>
        <source>Failed to create skylander file:
%1</source>
        <translation>创建小龙斯派罗文件失败：
%1</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <translation>小龙斯派罗管理器</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="771"/>
        <source>Select Skylander File</source>
        <translation>选择小龙斯派罗文件</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="771"/>
        <source>Skylander (*.sky);;</source>
        <translation>小龙斯派罗 (*.sky);;</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="787"/>
        <source>Failed to open the skylander file!</source>
        <translation>打开小龙斯派罗文件失败！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="787"/>
        <source>Failed to open the skylander file(%1)!
File may already be in use on the portal.</source>
        <translation>打开小龙斯派罗文件（%1）失败！
文件可能已经在 portal 中使用。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="794"/>
        <source>Failed to read the skylander file!</source>
        <translation>读取小龙斯派罗文件失败！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/skylander_dialog.cpp" line="794"/>
        <source>Failed to read the skylander file(%1)!
File was too small.</source>
        <translation>读取小龙斯派罗文件（%1）失败！
文件过小。</translation>
    </message>
</context>
<context>
    ...
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="21"/>
        <source>System Commands | %1</source>
        <translation>系统指令 | %1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="25"/>
        <source>Send Command</source>
        <translation>发送指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="28"/>
        <source>Send Custom Command</source>
        <translation>发送自定义指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="79"/>
        <source>Select Command</source>
        <translation>选择指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="84"/>
        <source>Select Custom Command</source>
        <translation>选择自定义指令</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="89"/>
        <source>Select Value</source>
        <translation>选择值</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="118"/>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="126"/>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="141"/>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="149"/>
...
请联系一个开发人员。</translation>
    ...
    <message>
        ...
        <translation>请先选择一个合适的值。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/system_cmd_dialog.cpp" line="141"/>
        <source>Please select a proper custom command first.</source>
        <translation>请先选择一个合适的自定义指令。</translation>
    </message>
</context>
<context>
    <name>system_state</name>
    <message>
        <location filename="rpcs3qt/debugger_frame.h" line="38"/>
        <source>No Thread</source>
        <translation>无线程</translation>
    </message>
    <message>
        <location filename="rpcs3qt/debugger_frame.h" line="39"/>
        <source>Run</source>
        <translation>运行</translation>
    </message>
    <message>
        <location filename="rpcs3qt/debugger_frame.h" line="40"/>
        <source>Pause</source>
        <translation>暂停</translation>
    </message>
</context>
<context>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="57"/>
        <source>Trophy Manager</source>
        <translation>奖杯管理</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="83"/>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1034"/>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="115"/>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="151"/>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="152"/>
    ...
    <message>
        ...
        <translation>显示解锁时间</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="161"/>
        <source>Show Not Earned Trophies</source>
        <oldsource>Show Locked Trophies</oldsource>
        <translation>显示未获得的奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="165"/>
        <source>Show Earned Trophies</source>
        <oldsource>Show Unlocked Trophies</oldsource>
        <translation>显示获得的奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="169"/>
        <source>Show Hidden Trophies</source>
        <translation>显示隐藏的奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="173"/>
        <source>Show Bronze Trophies</source>
        <translation>显示青铜奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="177"/>
        <source>Show Silver Trophies</source>
        <translation>显示白银奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="181"/>
        <source>Show Gold Trophies</source>
        <translation>显示黄金奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="185"/>
        <source>Show Platinum Trophies</source>
        <translation>显示白金奖杯</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="190"/>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="252"/>
        <source>Trophy Icon Size: %0x%1</source>
        <translation>奖杯图标尺寸：%0x%1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="193"/>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="281"/>
        <source>Game Icon Size: %0x%1</source>
        <translation>游戏图标尺寸：%0x%1</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="204"/>
        <source>Choose Game</source>
        <translation>选取游戏</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="209"/>
        <source>Trophy Info</source>
        <translation>奖杯信息</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="214"/>
        <source>Trophy View Options</source>
        <translation>奖杯视图选项</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="225"/>
        <source>Icon Options</source>
        <translation>图标选项</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="807"/>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="875"/>
        <source>&amp;Open Trophy Directory</source>
        <translation>&amp;打开奖杯目录</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="831"/>
        <source>&amp;Copy Name + Description</source>
        <translation>&amp;复制名称 + 描述</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="841"/>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="892"/>
        <source>&amp;Copy Name</source>
        <translation>&amp;复制名称</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="851"/>
        <source>&amp;Copy Description</source>
        <translation>&amp;复制描述</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="936"/>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="995"/>
        <source>%0% (%1/%2)</source>
        <translation>%0% (%1/%2)</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1069"/>
        <source>No</source>
        <translation>否</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1076"/>
        <source>Bronze</source>
        <comment>Trophy type</comment>
        <translation>青铜</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1077"/>
        <source>Silver</source>
        <comment>Trophy type</comment>
        <translation>白银</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1078"/>
        <source>Gold</source>
        <comment>Trophy type</comment>
        <translation>黄金</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1079"/>
        <source>Platinum</source>
        <comment>Trophy type</comment>
        <translation>白金</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1102"/>
        <source>Unknown</source>
        <translation>未知</translation>
    </message>
    <message>
        <location filename="rpcs3qt/trophy_manager_dialog.cpp" line="1104"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="70"/>
        <location filename="rpcs3qt/update_manager.cpp" line="85"/>
        <location filename="rpcs3qt/update_manager.cpp" line="166"/>
        <location filename="rpcs3qt/update_manager.cpp" line="340"/>
        <location filename="rpcs3qt/update_manager.cpp" line="348"/>
        <location filename="rpcs3qt/update_manager.cpp" line="360"/>
        <location filename="rpcs3qt/update_manager.cpp" line="650"/>
        <source>Auto-updater</source>
        <translation>自动更新器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="93"/>
...
Do you want to update?</source>
        <translation>一个更好版本的 RPCS3 现在可用！
...
你想更新吗？</translation>
    ...
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="203"/>
...
Do you want to update?</source>
        <oldsource>A new version of RPCS3 is available!

Current version: %0 (%1)
Latest version: %2 (%3)
Your version is %4 old.

Do you want to update?</oldsource>
        <translation>一个新版本 RPCS3 可用！
...
你想更新吗?</translation>
    ...
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="215"/>
...
你想更新到最新的官方 RPCS3 版本吗？</translation>
    ...
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="251"/>
        <location filename="rpcs3qt/update_manager.cpp" line="261"/>
        <source>N/A</source>
        <translation>N/A</translation>
    </message>
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="311"/>
        <source>． %0: %1</source>
        <translation>． %0: %1</translation>
    </message>
    <message>
...
%0</translation>
    ...
    <message>
        ...
        <translation>尝试更新前请停止模拟。</translation>
    </message>
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="650"/>
    ...
    <message>
        ...
        <translation>你的版本已经是最新的了！</translation>
    </message>
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="314"/>
        <source>Update Available</source>
        <translation>有更新可用</translation>
    </message>
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="366"/>
        <source>Downloading Update</source>
        <translation>正在下载更新</translation>
    </message>
    <message>
        <location filename="rpcs3qt/update_manager.cpp" line="371"/>
        <source>Updating RPCS3</source>
        <translation>正在更新 RPCS3</translation>
    </message>
</context>
<context>
    <name>user_manager_dialog</name>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="37"/>
        <source>User Manager</source>
        <translation>用户管理器</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="55"/>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="408"/>
        <source>User ID</source>
        <translation>用户 ID</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="55"/>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="409"/>
        <source>User Name</source>
        <translation>用户名称</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="273"/>
        <source>Rename User</source>
        <translation>重命名用户</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="73"/>
        <source>&amp;Close</source>
        <translation>&amp;关闭</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="61"/>
        <source>&amp;Delete User</source>
        <translation>&amp;删除用户</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="64"/>
        <source>&amp;Create User</source>
        <translation>&amp;创建用户</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="67"/>
        <source>&amp;Log In User</source>
        <translation>&amp;登入用户</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="70"/>
        <source>&amp;Rename User</source>
        <translation>&amp;重命名用户</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="225"/>
        <source>Delete Confirmation</source>
        <translation>删除确认</translation>
    </message>
    <message>
...
%2</translation>
    ...
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="274"/>
        <source>User Id: %0
Old Username: %1
...
新用户名：</translation>
    ...
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="285"/>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="323"/>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="342"/>
        <source>Error</source>
        <translation>错误</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="331"/>
        <source>New User</source>
        <translation>新用户</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="332"/>
...
现在停止模拟？</translation>
    ...
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="412"/>
        <source>&amp;Rename</source>
        <translation>&amp;重命名</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="413"/>
        <source>&amp;Login</source>
        <translation>&amp;登入</translation>
    </message>
    <message>
        <location filename="rpcs3qt/user_manager_dialog.cpp" line="414"/>
        <source>&amp;Open User Directory</source>
        <translation>&amp;打开用户目录</translation>
    </message>
</context>
<context>
    <name>vfs_dialog</name>
    <message>
        <location filename="rpcs3qt/vfs_dialog.cpp" line="49"/>
        <source>Reset Directories</source>
        <translation>重置目录</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>重置所有文件系统目录？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/vfs_dialog.cpp" line="18"/>
        <source>Virtual File System</source>
        <translation>虚拟文件系统</translation>
    </message>
</context>
<context>
    ...
    <message>
        ...
        <oldsource>%0 directory:</oldsource>
        <translation>已使用 %0 目录：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/vfs_dialog_path_widget.cpp" line="74"/>
        <source>Choose a directory</source>
        <translation>选取一个目录</translation>
    </message>
</context>
<context>
    <name>vfs_dialog_usb_input</name>
    <message>
        <location filename="rpcs3qt/vfs_dialog_usb_input.cpp" line="16"/>
        <source>Edit %0</source>
        <translation>编辑 %0</translation>
    </message>
    <message>
        <location filename="rpcs3qt/vfs_dialog_usb_input.cpp" line="27"/>
        <source>Reset All</source>
        <translation>重置所有</translation>
    </message>
    <message>
        <location filename="rpcs3qt/vfs_dialog_usb_input.cpp" line="45"/>
        <source>Confirm Reset</source>
        <translation>确认重置</translation>
    </message>
    <message>
        ...
        <translation>重置所有记录和文件系统目录？</translation>
    </message>
    <message>
        <location filename="rpcs3qt/vfs_dialog_usb_input.cpp" line="74"/>
        <source>Vendor ID:</source>
        <translation>供应商 ID：</translation>
    </message>
    <message>
        <location filename="rpcs3qt/vfs_dialog_usb_input.cpp" line="75"/>
...
<context>
    ...
    <message>
        <location filename="rpcs3qt/welcome_dialog.ui" line="20"/>
        <source>Welcome to RPCS3</source>
        <translation>欢迎来到 RPCS3</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="rpcs3qt/welcome_dialog.ui" line="254"/>
        <source>I have read the Quickstart guide</source>
        <translation>我已经阅读了快速入门指南</translation>
    </message>
    <message>
        <location filename="rpcs3qt/welcome_dialog.ui" line="274"/>
        <source>Do not show again</source>
        <translation>不再显示</translation>
    </message>
    <message>
        <location filename="rpcs3qt/welcome_dialog.cpp" line="30"/>
        <source>
			&lt;p style=&quot;white-space: nowrap;&quot;&gt;
				RPCS3 is an open-source Sony PlayStation 3 emulator and debugger.&lt;br&gt;
				It is written in C++ for Windows, Linux, FreeBSD and MacOS funded with &lt;a %0 href=&quot;https://www.patreon.com/Nekotekina&quot;&gt;Patreon&lt;/a&gt;.&lt;br&gt;
    ...
    <message>
        <location filename="rpcs3qt/welcome_dialog.cpp" line="41"/>
        <source>
			&lt;p style=&quot;white-space: nowrap;&quot;&gt;
...
<context>
    ...
    <message>
        ...
        <translation>RPCN 密码已保存</translation>
    </message>
    <message>
        <source>Your password was saved successfully!</source>
        <translation>你的密码已保存成功！</translation>
    </message>
    <message>
        <source>Failed to connect to RPCN server:\n%0</source>
        <translation>无法连接到 RPCN 服务器：\n%0</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>使用此用户名的账号已存在！</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>未知的创建错误</translation>
    </message>
    <message>
        <source>Unknown error!</source>
        <translation>未知错误！</translation>
    ...
    <message>
        ...
        <translation>创建账号时出错！</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>连接 RPCN 时出错！</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>你的账号有效！</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>你需要输入一个用户名和一个密码！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>添加好友时发生了一个错误！</translation>
    </message>
    <message>
        <source>Friend added!</source>
        <translation>朋友已添加！</translation>
...
按 ESC 键取消</translation>
    ...
    <message>
        <location filename="dialogs/qcolordialog.cpp" line="1671"/>
        <source>Select Color</source>
        <translation>选择颜色</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="dialogs/qmessagebox.cpp" line="1970"/>
        <location filename="dialogs/qmessagebox.cpp" line="2416"/>
        <source>OK</source>
        <translation>确定</translation>
    </message>
</context>
<context>
    ...
    <message>
        <location filename="widgets/qdockwidget.cpp" line="703"/>
        <source>Close</source>
...
<context>
    ...
    <message>
        <location filename="widgets/qmdisubwindow.cpp" line="343"/>
        <source>Close</source>
        <translation>关闭</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="dialogs/qprogressdialog.cpp" line="188"/>
        <source>Cancel</source>
        <translation>取消</translation>
    </message>
</context>
...
<context>
    <name>QWizard</name>
    <message>
        <location filename="dialogs/qwizard.cpp" line="713"/>
        <source>Cancel</source>
        <translation>取消</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <location filename="kernel/qplatformtheme.cpp" line="665"/>
        <source>OK</source>
        <translation>确定</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="kernel/qplatformtheme.cpp" line="685"/>
        <source>Ignore</source>
        <translation>忽略</translation>
    </message>
    <message>
        <location filename="kernel/qplatformtheme.cpp" line="687"/>
        <source>Close</source>
        <translation>关闭</translation>
    </message>
    <message>
        <location filename="kernel/qplatformtheme.cpp" line="689"/>
        <source>Cancel</source>
        <translation>取消</translation>
    </message>
    <message>
